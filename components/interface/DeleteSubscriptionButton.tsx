    ...
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <Button
          ...
          aria-label="Eliminar suscripción de esta cuenta"
        >
      ...
      <AlertDialogContent className="border-zinc-200 bg-white text-zinc-900 dark:bg-emerald-950 dark:border-emerald-700 dark:text-white">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Se eliminará la suscripción de este cliente en esta cuenta. En la base
            de datos, los pagos asociados a esta suscripción también se eliminan
